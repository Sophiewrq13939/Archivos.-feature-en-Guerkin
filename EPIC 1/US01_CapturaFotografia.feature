...
Examples:
    ...
    | usuario        | cultivo | accion              | resultado                  |
    | Luis Mariano   | Mango   | Tomar fotografía    | Fotografía capturada       |
    | Ana Torres     | Fresa   | Tomar fotografía    | Fotografía capturada       |
    | Carlos Pérez   | Limón   | Tomar fotografía    | Fotografía capturada       |