...
Example: 
      | tipo_alerta | titulo_notificacion     | mensaje_detalle                               | cultivo_afectado | leido   |
      | Push        | Diagnostico actualizado | El agronomo Ana Soliz cambio el estado a Alta | Manzana          | false   |